...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mars3d"] = factory(require("Cesium"), require("jQuery"), require("turf"), require("mapv"));
	else
		root["mars3d"] = factory(root["Cesium"], root["jQuery"], root["turf"], root["mapv"]);
...
var customControls = {
    ...
    function computedNewPos(camera, dir, rotate) {
        ...
        var winCenter = mars3d.point.getCenter(viewer);
        if (!winCenter) return;
...
function showFeature(item, options) {
    ...
    if (item.geometryType && item.geometryType.indexOf('esri') != -1) {
        ...
        if (JSON.stringify(item.geometry).length < 10000) {
            //屏蔽大数据，页面卡顿 
            var L = window.mars3d.L || window.L;
            if (L.esri) {
                feature = mars3d.L.esri.Util.arcgisToGeoJSON(item.geometry);
            } else {
...
var FlyLine = exports.FlyLine = function () {
    ...
    _createClass(FlyLine, [{
        ...
        value: function _createEntity() {
            ...
            var modelAttr = mars3d.draw.attr.model.style2Entity(this.options.model);
            var labelAttr = mars3d.draw.attr.label.style2Entity(this.options.label);
            var pathAttr = mars3d.draw.attr.polyline.style2Entity(this.options.path, {});
        ...
        value: function updateAngle(isAuto, opts) {
            if (isAuto) {
                ...
                var autoHpr = mars3d.matrix.getHeadingPitchRollByOrientation(position, _orientation);
        ...
        value: function addWallShading() {
            ...
            var that = this;
            var wallattr = mars3d.draw.attr.wall.style2Entity(this.options.shadow);
        ...
        value: function addCylinderShading() {
            ...
            var wallattr = mars3d.draw.attr.wall.style2Entity(this.options.shadow); //主要是颜色值等属性
...
var ViewShed3D = exports.ViewShed3D = function () {
    ...
    _createClass(ViewShed3D, [{
        ...
        value: function _bindMourseEvent() {
            ...
            handler.setInputAction(function (movement) {
                var cartesian = mars3d.point.getCurrentMousePosition(viewer.scene, movement.endPosition);
                if (!cartesian) return;
